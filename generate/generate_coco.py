...
def evaluate(args, net, valid_dataloaders, visualize=False):
    ...
    print("Validating...")
    index = 0
    train_datasets = register_all_coco_panoptic_annos_sem_seg()
    image_dict = {}
    max_value = 0
    min_value = 0
    ...
    for k in range(len(valid_dataloaders)):
        ...
        for data_val in metric_logger.log_every(valid_dataloader, 100):
            ...
            image_idx = int(img_name[0])
            segments_info = image_dict[image_idx]['segments_info']
            if torch.cuda.is_available():
            ...
            if args.infer_mode == 'single':
                ...
                for segment_info in segments_info:
                    ...
                    if not segment_info["iscrowd"] and coco_categories[class_id]['isthing'] == 1:
