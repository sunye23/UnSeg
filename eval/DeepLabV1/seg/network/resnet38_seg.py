...
class Net(network.resnet38d.Net):
    def __init__(self, num_classes):
        super().__init__()
        checkpoint_path = 'ilsvrc-cls_rna-a1_cls1000_ep-0001.params'
        weights_dict = network.resnet38d.convert_mxnet_to_torch(checkpoint_path)
        self.load_state_dict(weights_dict)
        print("Seg Backbone weight has been loaded...")
