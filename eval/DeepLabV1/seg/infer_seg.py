...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default="save_dir/model_iterate_final.pth", type=str)
    parser.add_argument("--network", default="resnet38_seg", type=str)
    parser.add_argument("--gt_path", default="VOCtrainval_11-May-2012/VOCdevkit/VOC2012/SegmentationClass", type=str)
    parser.add_argument("--save_path", default='val_ms_crf', type=str)
    parser.add_argument("--save_path_c", default='val_ms_crf_c', type=str)
    ...
    parser.add_argument("--scales", default=1, type=float, nargs='+')
    ...
    print("Load infer weight from: {}".format(args.weights))
    model.load_state_dict(torch.load(args.weights))
    print("model weight has been loaded from {}".format(args.weights))
