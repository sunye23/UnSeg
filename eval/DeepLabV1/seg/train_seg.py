...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_ids', type=str, default='6,7', help='GPU_id')

    parser.add_argument("--list_path", default="voc12/train_id.txt", type=str)
    parser.add_argument("--img_path", default="image_aug", type=str)
    # parser.add_argument("--img_path", default="VOCtrainval_11-May-2012/VOCdevkit/VOC2012/JPEGImages", type=str)
    # parser.add_argument("--img_path", default="VOCtrainval/poison_all300_mask_only_maeweight(mask)", type=str)
    parser.add_argument("--save_path", default="save_dir/", type=str)
    parser.add_argument("--seg_pgt_path", default="label_aug", type=str)
    # parser.add_argument("--seg_pgt_path", default="VOCtrainval_11-May-2012/VOCdevkit/VOC2012/SegmentationClassAug", type=str)
    ...
    parser.add_argument("--init_weights", default=None, type=str)
    ...
    print("Img_path = {}".format(args.img_path))
    print("Label_path = {}".format(args.seg_pgt_path))
    print("Gpu_ids = {}".format(args.gpu_ids))
    ...
    print("Save trained weight to: {}".format(os.path.join(save_path,  args.session_name + 'final.pth')))
